        ...
        >
          <p
            className={cn(
              ...
              incognitoMode ? "text-slate-400/70" : "text-muted-foreground/70",
            )}
          >
            • Use{" "}
            <span
              className={cn(
                "font-medium",
                incognitoMode ? "text-slate-200" : "text-foreground/80",
              )}
            >
              Digital Art
            </span>{" "}
              ...
              <div className="flex-1 min-w-0">
                <p
                  className={cn(
                    ...
                    incognitoMode ? "text-slate-200/70" : "text-foreground/70",
                  )}
                >
                  {r.label}
                </p>
        ...
        >
          ...
          <div
            className={cn(
              ...
              incognitoMode ? "bg-slate-500/10" : "bg-muted",
            )}
          >
            <div
