...
const models = [
  {
    ...
    desc: "Best for real-world photographs",
  },
  {
    id: "general-fast",
    label: "General Photo (Fast Real-ESRGAN)",
    desc: "Faster, slightly lower fidelity",
  },
  {
    id: "remacri",
    label: "General Photo (Remacri)",
    desc: "Crisp natural details",
  },
  {
    id: "ultramix",
    label: "General Photo (Ultramix Balanced)",
    desc: "Balanced sharpness & smoothness",
  },
  {
    id: "ultrasharp",
    label: "General Photo (Ultrasharp)",
    desc: "Maximum sharpness for prints",
  },
  {
    id: "digital-art",
    label: "Digital Art",
    desc: "Optimized for illustrations & paintings",
  },
    ...
    <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-5">
      ...
      <div
        className={cn(
          ...
          incognitoMode
            ? "bg-slate-950/10 border-slate-500/10"
            : "glass border-glass shadow-float",
        )}
      >
        <div className="flex items-center justify-between">
          <p
            className={cn(
              ...
              incognitoMode ? "text-slate-400/30" : "text-muted-foreground/60",
            )}
          >
            Workflow
          </p>
          <button
            ...
            className={cn(
              ...
              batch
                ...
                : incognitoMode
                  ? "bg-slate-500/5 text-slate-400/40 hover:bg-slate-500/10"
        ...
        <div>
          <p
            className={cn(
              ...
              incognitoMode ? "text-slate-200/80" : "text-foreground/80",
            )}
          >
            Step 1
          </p>
          ...
          <button
            ...
            className={cn(
              ...
              incognitoMode
                ...
                : "bg-muted-foreground/10 hover:bg-muted-foreground/30 text-foreground/80",
            )}
          >
        ...
        <div>
          ...
          <div className="relative">
            {/* Model dropdown trigger — muted-foreground/10, hover muted-foreground/30 */}
            <button
            ...
            {modelOpen && (
              <div
                className={cn(
                  ...
                  incognitoMode
                    ? "bg-[#111111] border-slate-500/20 shadow-[0_8px_30px_rgba(0,0,0,0.5)]"
                    : "glass-strong border-glass",
                )}
              >
                {models.map((m) => (
                  <button
                    ...
                    className={cn(
                      ...
                      m.id === model.id
                        ...
                        : incognitoMode
                          ? "text-slate-400/40 hover:bg-slate-500/10 hover:text-slate-200"
            ...
            <button
              ...
              className={cn(
                ...
                doubleUpscale
                  ...
                  : incognitoMode
                    ? "border-slate-500/20 bg-transparent"
          ...
          {/* Image scale — muted-foreground/10, selected muted-foreground/30 */}
          <div className="mt-3">
            <p
              className={cn(
                "text-[11px] mb-1.5",
                  ...
                  className={cn(
                    ...
                    s === scale
                      ? incognitoMode
                        ...
                        : "bg-muted-foreground/30 text-foreground"
                      : incognitoMode
                        ? "bg-slate-500/10 text-slate-400/40 hover:bg-slate-500/20 hover:text-slate-300"
                        : "bg-muted-foreground/10 text-muted-foreground/70 hover:bg-muted-foreground/30 hover:text-foreground",
                  )}
                >
                  {s}x
                </button>
        ...
        {/* Step 3 — muted-foreground/10, hover muted-foreground/30 */}
        <div>
          <p
            className={cn(
              "text-[11px] font-semibold mb-1.5",
        ...
        {/* Step 4 — keep gradient-accent as CTA */}
        <div>
          <p
            className={cn(
              "text-[11px] font-semibold mb-1.5",
          ...
          >
            ...
            >
              <ImageIcon
                className={cn(
                  "w-6 h-6",
                  incognitoMode ? "text-slate-950" : "text-primary-foreground",
                )}
              />
            </div>
            <h3
              className={cn(
                ...
                incognitoMode ? "text-slate-200" : "text-foreground/90",
              )}
            >
            ...
            <button
              ...
              className={cn(
                ...
                incognitoMode
                  ? "bg-slate-500/10 text-slate-400/40 hover:bg-slate-500/20 hover:text-slate-200"
                  : "bg-muted-foreground/10 hover:bg-muted-foreground/30 text-foreground/80",
              )}
            >
          ...
          <div className="w-full h-full p-5">
            ...
            <div className="relative w-full h-full flex items-center justify-center">
              <img
                src={imageUrl}
                alt="preview"
                className="max-h-[420px] max-w-full rounded-xl shadow-float object-contain"
              />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div
                    className={cn(
                      ...
                      incognitoMode
                        ? "bg-[#111111] border-slate-500/20"
                        : "glass-strong border-glass",
                    )}
                  >
                    <Sparkles
                      className={cn(
                        "w-5 h-5 mx-auto mb-2 animate-pulse",
                        incognitoMode ? "text-slate-400" : "text-primary",
                      )}
                    />
                    <p
                      className={cn(
                        "text-[13px] font-semibold",
                        incognitoMode ? "text-slate-200" : "text-foreground",
                      )}
                    >
                      Hold on…
                    </p>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        incognitoMode
                          ? "border-slate-500/20 text-slate-400/40 hover:bg-slate-500/10 hover:text-slate-200"
                          : "border-border text-foreground/70 hover:bg-muted-foreground/10",
                      )}
                    >
                      STOP
                    </button>
